...
function FeedbackForm({id}) {
    ...
    const {addFeedbackItem, feedbackEditableItem, feedbackEditFlag, updateFeedbackItem} = useContext(FeedbackContext)
    ...
    return (
        <Card>
            <form onSubmit={handleSubmit}>
                ...
                <RatingSelect id={id} select={(rating) => setRating(rating)} selected={rating} />
